...
<script type="text/javascript">
	...
	function viewFile(opaFts,sno,right,contractorName)
	{
		if(right==1)
		{
			var url="viewFile?id="+opaFts+"&sno="+sno+"&department=HR&prFlage=null&name="+contractorName;
	...
	{
		if(right==1)
			window.location="downloadFile?id="+opaFts+"&sno="+sno+"&department=HR";
	}
			...
			<tbody>
				<c:forEach items="${records}" var="record">
					<tr>
						...
						<td>
							<a href="#" onclick="viewFile('${record.fileNo}','${record.sno}','${view}','${record.file_Subject}')" style="text-decoration: none;">View</a>&nbsp;&nbsp;
							...
							<c:if test="${print=='1'}"><a href="#" onclick="printOut('${record.opaFts}','${record.sno}','${print}','${record.fileNo}');" style="text-decoration: none;">Print</a></c:if>
						</td>
					</tr>
				</c:forEach>
			</tbody>
