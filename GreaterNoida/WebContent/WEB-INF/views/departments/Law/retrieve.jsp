...
<script type="text/javascript">
	...
	function getPage(type,page)
	{
		...
		{
			currentNote=page;
			div.innerHTML='<object oncontextmenu="return false" style="height: 100%; width: 100%;" data="staticResources/pdfs/'+petitionNum+'L@'+page+'L.pdf#toolbar=0"></object>';
		}
		else
		{
			currentCorr=page;
			div.innerHTML='<object oncontextmenu="return false" style="height: 100%; width: 100%;" data="staticResources/pdfs/'+petitionNum+'R@'+page+'R.pdf#toolbar=0"></object>';
		}
		}
	...
	function printOut(pos,sno,right,bankName)
	{
		if(right==1)
		{
			var url="viewFile?id="+pos+"&sno="+sno+"&department=Law&prFlage=print&name="+bankName;
	...
	function singlePrint()
	{
		...
		if(type=='note')
			contentDiv.innerHTML='<iframe id="singlePdf" src="staticResources/pdfs/'+petitionNo+'L@'+currentNote+'L@print.pdf"></iframe>';
		else
			contentDiv.innerHTML='<iframe id="singlePdf" src="staticResources/pdfs/'+petitionNo+'R@'+currentCorr+'R@print.pdf"></iframe>';
